...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="py-24 px-6 md:px-20 bg-[#0f0f0f] text-white relative overflow-hidden"
    >
      {/* Glow */}
          ...
          >
            ...
            >
              <p className="text-sm text-gray-400 leading-relaxed">
                For enterprise inquiries, custom solutions, or technical support, use the contact form or reach out directly via email.
              </p>
            </motion.div>
          </motion.div>
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 rounded-lg bg-[#0f0f0f] border border-gray-800 text-white placeholder-gray-500 focus:border-[#ff7b00]/60 focus:ring-1 focus:ring-[#ff7b00]/30 transition-all duration-300"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  className="w-full px-4 py-3 rounded-lg bg-[#0f0f0f] border border-gray-800 text-white placeholder-gray-500 focus:border-[#ff7b00]/60 focus:ring-1 focus:ring-[#ff7b00]/30 transition-all duration-300 resize-none"
